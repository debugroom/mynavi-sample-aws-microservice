...
@EnableJpaRepositories(
        basePackages = "org.debugroom.mynavi.sample.aws.microservice.backend.user.domain.repository"
)
public class JpaConfig{
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan(
                "org.debugroom.mynavi.sample.aws.microservice.backend.user.domain.model.entity");
